...
class Goal(Base, IdMixin, TimestampMixin):
    ...
    parent_id: Mapped[uuid.UUID | None] = mapped_column(GUID(), ForeignKey("goals.id"), nullable=True)
...
class Task(Base, IdMixin, TimestampMixin):
    ...
    parent_task_id: Mapped[uuid.UUID | None] = mapped_column(GUID(), ForeignKey("tasks.id"), nullable=True)
    goal_id: Mapped[uuid.UUID | None] = mapped_column(GUID(), ForeignKey("goals.id"), nullable=True)
    ...
    origin_device_id: Mapped[uuid.UUID | None] = mapped_column(GUID(), ForeignKey("devices.id"), nullable=True)
    target_device_id: Mapped[uuid.UUID | None] = mapped_column(GUID(), ForeignKey("devices.id"), nullable=True)
...
class AgentRun(Base, IdMixin, TimestampMixin):
    ...
    task_id: Mapped[uuid.UUID | None] = mapped_column(GUID(), ForeignKey("tasks.id"), nullable=True, index=True)
    step_id: Mapped[uuid.UUID | None] = mapped_column(GUID(), ForeignKey("task_steps.id"), nullable=True)
...
class SkillRun(Base, IdMixin, TimestampMixin):
    ...
    skill_version_id: Mapped[uuid.UUID] = mapped_column(GUID(), ForeignKey("skill_versions.id"), index=True)
    task_id: Mapped[uuid.UUID | None] = mapped_column(GUID(), ForeignKey("tasks.id"), nullable=True)
