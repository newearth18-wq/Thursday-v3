...
[docs/15-vertical-slice.md](docs/15-vertical-slice.md) works end to end, with 1,800 tests that
...
plus the [V2 review](docs/architecture/00-v2-review.md) and fifty-five
...
pytest                       # 1,800 tests, no infrastructure
