...
[docs/15-vertical-slice.md](docs/15-vertical-slice.md) works end to end, with 945 tests that
...
plus the [V2 review](docs/architecture/00-v2-review.md) and thirty-three
...
pytest                       # 945 tests, no infrastructure
