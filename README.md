...
[docs/15-vertical-slice.md](docs/15-vertical-slice.md) works end to end, with 2,526 tests that
...
[V2 review](docs/architecture/00-v2-review.md) and seventy-nine
...
pytest                       # 2,526 tests, no infrastructure
