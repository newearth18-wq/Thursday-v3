...
[docs/15-vertical-slice.md](docs/15-vertical-slice.md) works end to end, with 1,284 tests that
...
plus the [V2 review](docs/architecture/00-v2-review.md) and forty-eight
...
pytest                       # 1,284 tests, no infrastructure
