...
[docs/15-vertical-slice.md](docs/15-vertical-slice.md) works end to end, with 916 tests that
...
plus the [V2 review](docs/architecture/00-v2-review.md) and thirty-two
...
pytest                       # 916 tests, no infrastructure
