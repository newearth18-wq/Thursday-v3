...
[docs/15-vertical-slice.md](docs/15-vertical-slice.md) works end to end, with 2,435 tests that
...
[V2 review](docs/architecture/00-v2-review.md) and seventy-two
...
pytest                       # 2,435 tests, no infrastructure
