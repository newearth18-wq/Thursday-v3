...
[docs/15-vertical-slice.md](docs/15-vertical-slice.md) works end to end, with 2,554 tests that
...
[V2 review](docs/architecture/00-v2-review.md) and eighty-two
...
pytest                       # 2,554 tests, no infrastructure
