...
[docs/15-vertical-slice.md](docs/15-vertical-slice.md) works end to end, with 897 tests that
...
plus the [V2 review](docs/architecture/00-v2-review.md) and thirty-one
...
pytest                       # 897 tests, no infrastructure
