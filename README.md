...
[docs/15-vertical-slice.md](docs/15-vertical-slice.md) works end to end, with 2,520 tests that
...
[V2 review](docs/architecture/00-v2-review.md) and seventy-eight
...
- 127 REST operations, two WebSockets, 29-table schema with working migrations and seeds
...
pytest                       # 2,520 tests, no infrastructure
